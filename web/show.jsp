<%-- 
    Document   : show
    Created on : Jun 18, 2022, 2:41:07 AM
    Author     : fakhr
--%>
<%@page import="java.sql.*" errorPage="error.jsp"%>
<%!
    String title,fname,lname,email,country,phone,room_type,bed_type,tpackage,cin_date,cout_date;
    int id,nroom,nodays;
